...
//            String messageToSend=message + ";" + requestCount;
    ...
    public static void ListenFrontEnd() throws IOException, ClassNotFoundException {
...
//            socketForReplicaFour.send(packetForFour);
    ...
    public static void checkResponseFromReplicas(String resReplicaOne, String resReplicaTwo, String resReplicaThree, String resReplicaFour) {
    ...
    public static void bugCount(int rmNumber) {
        switch(rmNumber) {
            case 0:{
                bugCountRmOne++;
                if (bugCountRmOne==3) {
    ...
    public static String majorityResponse(String resReplicaOne, String resReplicaTwo, String resReplicaThree, String resReplicaFour){
    ...
    public static String sendSoftwareFailureMsgToRM(DatagramSocket socket, DatagramPacket packet, byte[] softwareFailureByteArray) throws IOException {
    ...
    public static String sendCrashFailureMsgToRM(DatagramSocket socket, DatagramPacket packet, byte[] crashFailureByteArray) throws IOException {
        InetAddress addressReplicaOne=packet.getAddress();
        int portReplicaOne=packet.getPort();
