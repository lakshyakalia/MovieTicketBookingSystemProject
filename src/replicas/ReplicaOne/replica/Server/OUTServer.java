package replicas.ReplicaOne.replica.Server;

import replicas.ReplicaOne.replica.Services.MovieTicketService;
...
public class OUTServer {
    ...
    private static final String serverEndPoint = "http://localhost:8091/outremont";
