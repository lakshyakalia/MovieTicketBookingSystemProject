...
@WebService(endpointInterface = "replica.ReplicaOne.replica.Interface.MovieInterface")
...
//                            responseString = "Movie Tickets Exchanged!";
    ...
    public void writeToLogFile(String operation, String params, String status, String response) {
        try {
            FileWriter myLogWriter = new FileWriter("C:\\Users\\laksh\\Intellij-workspace\\MovieTicketBookingSystemProject\\src\\replica\\ReplicaOne\\replica\\Logs\\"+file.get(this.serverName),true);
