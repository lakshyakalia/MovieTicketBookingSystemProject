...
import replicas.ReplicaTwo.replica.Interface.MovieInterface;
...
//              recieved=new String(packet.getData(),0,packet.getLength()).trim().toString();
                System.out.println("Repica Two recieved... "+received);
...
//            TODO: Replace instance of replica
    ...
    public static void initializeServices() throws MalformedURLException {
        URL atwaterURL = new URL("http://localhost:8110/atwater?wsdl");
        QName atwaterQName = new QName("http://Services.replica.ReplicaTwo.replicas/", "MovieTicketServiceService");
        atwService = Service.create(atwaterURL, atwaterQName);

        URL outremontURL = new URL("http://localhost:8111/outremont?wsdl");
        QName outremontQName = new QName("http://Services.replica.ReplicaTwo.replicas/", "MovieTicketServiceService");
        outService = Service.create(outremontURL, outremontQName);

        URL verdunURL = new URL("http://localhost:8112/verdun?wsdl");
        QName verdunQName = new QName("http://Services.replica.ReplicaTwo.replicas/", "MovieTicketServiceService");
