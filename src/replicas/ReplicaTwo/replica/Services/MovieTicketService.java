...
//                            responseString = "Movie Tickets Exchanged!";
    ...
    public void writeToLogFile(String operation, String params, String status, String response) {
        try {
            FileWriter myLogWriter = new FileWriter("C:\\Users\\manish\\IdeaProjects\\FaultTolorentTicketMagementSystem\\src\\replicas\\ReplicaTwo\\replica\\Logs\\"+file.get(this.serverName),true);
