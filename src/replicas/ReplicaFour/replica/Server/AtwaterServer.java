package replicas.ReplicaFour.replica.Server;
...
public class AtwaterServer {
	public static void main(String [] args) throws Exception {
		...
		Endpoint endpoint= Endpoint.publish("http://localhost:8090/atwater",atwMovieBookingImplementation);
			...
			while(true){
				...
				switch(function) {
					...
					case "bookMovieTicket":{
						String result=atwMovieBookingImplementation.bookMovieTickets(userID, movieSlotID, movieName, numberOfTickets);
						responseReturn=result;
						break;
					}
					...
					case "bookingInExchange":{
						String result=atwMovieBookingImplementation.bookMovieTickets(userID, newMovieID, newMovieName, numberOfTickets);
						responseReturn=result;
						break;
					}
